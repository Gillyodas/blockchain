...
getContractFactory(name: 'MyWallet', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.MyWallet__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'MyWallet', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.MyWallet>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'MyWallet', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.MyWallet>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'MyWallet', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.MyWallet>
